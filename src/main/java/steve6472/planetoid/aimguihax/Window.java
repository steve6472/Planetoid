...
public abstract class Window {
     ...
     */
    protected final Color colorBg = new Color(.0f, .0f, .0f, 0.0f);
    ...
    protected void initWindow(final Configuration config) {
        ...
        handle = GLFW.glfwCreateWindow(1, 1, config.getTitle(), MemoryUtil.NULL, MemoryUtil.NULL);

        // Hack to hide the window from toolbar
        long hwnd = GLFWNativeWin32.glfwGetWin32Window(handle);
        User32.SetWindowLongPtr(hwnd, User32.GWL_EXSTYLE, User32.WS_EX_TOOLWINDOW);
